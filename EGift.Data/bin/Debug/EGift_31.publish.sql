...
GO
ALTER TABLE [dbo].[Orders] DROP CONSTRAINT [DF__tmp_ms_xx_Or__Id__4BAC3F29];
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Orders])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Orders] ([Id], [ProductId], [OrderedQuantity], [EGiftId], [RecipientName], [RecipientEmailAddress], [SenderName], [SenderEmailAddress], [DateOrdered], [AdditionalMessage])
        SELECT   [Id],
                 [ProductId],
                 [OrderedQuantity],
                 [EGiftId],
