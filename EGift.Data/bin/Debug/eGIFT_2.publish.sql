...
GO
ALTER TABLE [dbo].[Orders] DROP CONSTRAINT [DF__Orders__Id__1CF15040];
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Orders])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Orders] ([Id], [ProductId], [RecipientName], [RecipientEmailAddress], [SenderName], [SenderEmailAddress], [DateOrdered])
        SELECT   [Id],
                 [ProductId],
                 [RecipientName],
...
GO
PRINT N'Creating unnamed constraint on [dbo].[EGifts]...';


GO
ALTER TABLE [dbo].[EGifts]
